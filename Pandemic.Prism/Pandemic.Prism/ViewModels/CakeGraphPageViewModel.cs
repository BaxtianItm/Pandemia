...
{
    public class CakeGraphPageViewModel : ViewModelBase
    {
        ...
        public CakeGraphPageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
        ...
        private async void LoadReports()
        {
            ...
            Response response = await _apiService.Statistics<Statistics>(_url, "/api", "/Reports/StatisticsCake");
